...
import TextArea from 'src/@core/components/ui/form/text-area';
import Heading from 'src/@core/components/ui/heading';
import Text from 'src/@core/components/ui/text';
import cn from 'classnames';
import Rate from 'src/@core/components/ui/rate';
